...
export default function Sidebar({ isOpen, onToggle, topOffset = 0 }: SidebarProps) {
  ...
  const aiStudioItems = [
    ...
    { id: 'retention_ai', icon: BarChart3, label: 'Retention AI', href: '/dashboard/retention-ai' },
    { id: 'hook_analyzer', icon: Film, label: 'Hook Analyzer', href: '/dashboard/hook-analyzer' },
    { id: 'thumbnail_analyzer', icon: Image, label: 'Thumbnail Intelligence', href: '/dashboard/thumbnail-analyzer' },
    { id: 'competitor_spy', icon: Search, label: 'Competitor Spy', href: '/dashboard/competitor-spy' },
    { id: 'content_workflow', icon: Sparkles, label: 'Content Workflow', href: '/dashboard/content-workflow' },
